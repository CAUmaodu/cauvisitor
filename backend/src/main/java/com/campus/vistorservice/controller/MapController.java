...
public class MapController {
    ...
    @GetMapping("/pointmodel/search")
    public JSONObject searchPoints(@RequestParam("name") String name) {
        return buildGeoJSONFeatureCollection(pointService.searchPointsByName(name));
    }
